...
from imperaos_computer_use.adapters import BrowserAdapter, FileDialogAdapter, WindowMetadata
from imperaos_computer_use.adapters._macos import MacOSAutomationError
...
from imperaos_computer_use.runtime import (
    ComputerUseRunner,
    RuntimeAdapters,
    SessionCommand,
    SessionControlBus,
...
def test_computer_use_readiness_report_flags_safari_javascript_blocker(
    ...
    monkeypatch.setattr(
        "imperaos_computer_use.runtime.shutil.which",
    ...
    monkeypatch.setattr(
        "imperaos_computer_use.runtime.subprocess.run",
    ...
    monkeypatch.setattr(
        "imperaos_computer_use.runtime.run_applescript",
