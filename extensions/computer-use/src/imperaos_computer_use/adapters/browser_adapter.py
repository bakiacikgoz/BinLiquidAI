...
from imperaos_computer_use.adapters._macos import applescript_quote, run_applescript
from imperaos_computer_use.adapters.desktop_adapter import DesktopAdapter
