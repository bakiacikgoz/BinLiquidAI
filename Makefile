...
assistant-system-knowledge-gate:
	uv run python scripts/run_assistant_system_knowledge_gate.py --profile enterprise --json
...
local-product-ready: local-product-readiness-gate

local-product-ready-macos:
