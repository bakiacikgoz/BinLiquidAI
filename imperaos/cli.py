...
from imperaos.contracts.retired_capabilities import retired_computer_use_capabilities
...
def operator_capabilities(
    ...
    computer_use_pilot, computer_use_vision_runtime = retired_computer_use_capabilities(
        platform_info.label
    )
    payload = {
        ...
        "commands": {
            ...
            "computerUseSubmit": False,
            "computerUsePause": False,
            "computerUseResume": False,
            "computerUseStop": False,
            "computerUseStateJson": False,
            "computerUseSummaryJson": False,
        },
        "artifactSchema": {
            "auditEnvelope": "3",
            "events": "3",
