...
def write_native_conformance_report(
    *,
    ...
    json_path = output_root / "native_adapter_gate_report.json"
    markdown_path = output_root / "NATIVE_ADAPTER_GATE_REPORT.md"
...
def verify_native_conformance_evidence(*, output_root: Path) -> dict[str, Any]:
    violations: list[str] = []
