...
from binliquid.model_providers.errors import InvalidProviderConfig, ProviderRegistryError
...
def resolve_model_provider_registry(
    *,
    ...
    for provider_id, raw in raw_providers.items():
        ...
        providers.append(
            _apply_env_activation(record, remote_enabled=remote_enabled, env=env or os.environ)
        )
