...
from binliquid.control_plane.pilot_workflow_evidence import find_raw_leaks
...
def collect_field_evidence_bundle(
    *,
    ...
    try:
        from binliquid.memory.runtime_policy_snapshot import (
...
def _field_item(
    *,
    ...
    return FieldEvidenceItem(
        ...
        generatedAtUtc=generated_at,
        producer="binliquid.control_plane.field_evidence",
