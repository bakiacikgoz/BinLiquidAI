  ...
  return {
    ...
    memoryGovernance: {
      ...
      index: {
        ...
        recordCount: 0,
        lastRebuildAt: null,
        degradedReason: 'snapshot_unavailable',
        blockingReasons: ['SNAPSHOT_UNAVAILABLE'],
        experimental: false,
      },
      privacy: {
    ...
    memorySync: {
      enabled: false,
      status: 'disabled',
      exportRawContent: false,
      importApplyRequiresApproval: true,
      allowCrossEnvironmentImport: false,
      lastPackRef: null,
      warnings: ['SNAPSHOT_UNAVAILABLE'],
    },
    memoryAuthority: {
