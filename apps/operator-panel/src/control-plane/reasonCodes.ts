...
export const reasonCodeMessages: Record<UiLocale, Record<string, string>> = {
  en: {
    ...
    COMPUTER_USE_FALSE_READY: 'A computer-use live claim is not blocked and must fail closed.',
    ENTERPRISE_HAT_A_NOT_READY: 'Enterprise Hat A signed closure is not ready.',
    ...
    PREVIEW_SOURCE_NOT_LIVE_EVIDENCE: 'Preview fixture data is not live pilot evidence.',
    PUBLIC_DESKTOP_FALSE_READY: 'Public desktop installer claim must remain blocked.',
  ...
  tr: {
    ...
    COMPUTER_USE_FALSE_READY: 'Canlı computer-use claim’i bloke değil; fail-closed olmalı.',
    ENTERPRISE_HAT_A_NOT_READY: 'Enterprise Hat A imzalı closure hazır değil.',
    ...
    PREVIEW_SOURCE_NOT_LIVE_EVIDENCE: 'Preview fixture verisi canlı pilot kanıtı değildir.',
    PUBLIC_DESKTOP_FALSE_READY: 'Public desktop installer claim’i bloke kalmalıdır.',
